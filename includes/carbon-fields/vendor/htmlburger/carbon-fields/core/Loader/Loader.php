...
class Loader {
	...
	public function boot() {
		...
		Carbon_Fields::service( 'legacy_storage' )->enable();

		# Enable the meta query service
		Carbon_Fields::service( 'meta_query' )->enable();

		# Enable the REST API service
		Carbon_Fields::service( 'rest_api' )->enable();
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_style( 'carbon-fields-core', URL . '/assets/dist/carbon.css', array(), VERSION );

		wp_enqueue_script( 'carbon-fields-vendor', URL . '/assets/dist/carbon.vendor' . $suffix . '.js', array( 'jquery' ), VERSION );
		wp_enqueue_script( 'carbon-fields-core', URL . '/assets/dist/carbon.core' . $suffix . '.js', array( 'carbon-fields-vendor', 'quicktags', 'editor' ), VERSION );
		wp_enqueue_script( 'carbon-fields-boot', URL . '/assets/dist/carbon.boot' . $suffix . '.js', array( 'carbon-fields-core' ), VERSION );
