...
class Sidebar_Manager {
	...
	public function enqueue_scripts() {
		wp_enqueue_style( 'carbon-sidebar-manager', URL . '/core/Libraries/Sidebar_Manager/assets/css/app.css', array(), VERSION );
		wp_enqueue_script( 'carbon-sidebar-manager', URL . '/core/Libraries/Sidebar_Manager/assets/js/app.js', array(), VERSION );
